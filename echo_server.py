    ...
    def run(self):
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as __socket:
            ...
            while True:
                ...
                self.connection, remote_address = __socket.accept()
...
if __name__ == '__main__':
    Server().run()
    """
    Пример: В браузера ввести
            http://localhost/:5050
            http://localhost/:5050/?status=404
            http://localhost/:5050/?a=1&status=200&q=1
    """
